...
cli.responders.help = function(){
    var commands = {
        ...
        'list logs' : 'Show a list of all the log files available th be read (compressed only)',
...
cli.prcessInput = function(str) {
    ...
    if(str) {
        ...
        if(!matchFound) {
            console.log("Sorry the command '"+str+"' not recognize, try again");
        }
    }
};
